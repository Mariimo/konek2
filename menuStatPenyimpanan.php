...
<html lang="en">
  ...
  <body>
    ...
    <section id="interface">
      ...
      <h3 class="i-name">Divisi Penyimpanan</h3>
      <div class="board">
        <div>
...
<script>
  ...
  var barChart = new Chart(document.getElementById("barChart2"), {
    ...
    <tbody>
      <?php
      // Query SQL
      $sql = "SELECT tugas_id, tugas_nama, divisi_nama, tanggal, status, deadline FROM tugas INNER JOIN divisi ON tugas.divisi_id = divisi.divisi_id WHERE tugas.divisi_id = 5";
